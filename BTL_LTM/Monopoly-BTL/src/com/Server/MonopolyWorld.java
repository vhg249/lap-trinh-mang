...
public class MonopolyWorld implements Runnable {
    ...
    {
        if(isBuying==false) players[i].setAsset(players[i].getAsset()-tk);
            ...
            for(int i=0; i<numPlayer; i++)
            {
                ...
                if(msg.startsWith("rolldice"))
                {
                     ...
                     if(pos%5==0 && pos%10!=0)
                    {
                        ...
                        {
                            System.out.println("I will buy this property "+String.valueOf(stations[idx].getRecordID()));
                    ...
                    else if(pos == 12 || pos == 28)
                    {
                        ...
                        {
                            System.out.println("I will buy this property "+String.valueOf(utilities[idx].getRecordID()));
                    ...
                    else if(pos == 1 || pos == 3 || pos == 6 || pos == 8 || pos == 9 || pos == 11 || pos == 13 || pos == 14 || pos == 16 || pos == 18 || pos == 19 || pos == 21 || pos == 23 || pos == 24 || pos == 26 || pos == 27 || pos == 29 || pos == 31 || pos == 32 || pos == 34 || pos == 37 || pos == 39)
                    {
                        ...
                        System.out.println("The house will be able to settle down "+buildHouseEligibilityCheck(properties[idx], i, pos) );
                        ...
                        {
                            System.out.println("I will "+"buy this property"+String.valueOf(properties[idx].getRecordID()));
...

                    {
                        ...
                        for (int x = 0; x<players[i].getRecords().size(); x++)
                            System.out.println(players[i].getRecords().elementAt(x) +" at "+board[players[i].getRecords().elementAt(x)]);
                ...
                for(int ii=0; ii<numPlayer; ii++)
                {
                    if(players[ii].getCash()<=0)
                    {
                        ...
                        for(int j=0; j<numPlayer; j++)
                        {
                            ...
                            {
                                if(players[j].getAsset()>max) max = players[j].getAsset();
                                maxidx= j;
                            }
                        }
