...
public class Chess extends JPanel{
	...
	public final void loadSprites() {
		...
		whiteKing   = tkit.getImage("./Sprites/whiteKing.png");
		whiteQueen  = tkit.getImage("./Sprites/whiteQueen.png");
		whiteRook   = tkit.getImage("./Sprites/whiteRook.png");
		whiteBishop = tkit.getImage("./Sprites/whiteBishop.png");
		whiteKnight = tkit.getImage("./Sprites/whiteKnight.png");
		whitePawn   = tkit.getImage("./Sprites/whitePawn.png");
		blackKing   = tkit.getImage("./Sprites/blackKing.png");
		blackQueen  = tkit.getImage("./Sprites/blackQueen.png");
		blackRook   = tkit.getImage("./Sprites/blackRook.png");
		blackBishop = tkit.getImage("./Sprites/blackBishop.png");
		blackKnight = tkit.getImage("./Sprites/blackKnight.png");
		blackPawn   = tkit.getImage("./Sprites/blackPawn.png");
	}
